...
import { idlFactory } from './russian_roulette_frontend.did.js';
export { idlFactory } from './russian_roulette_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RUSSIAN_ROULETTE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./russian_roulette_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the russian_roulette_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./russian_roulette_frontend.did.js")._SERVICE>}
 */
export const russian_roulette_frontend = createActor(canisterId);
